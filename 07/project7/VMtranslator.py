...
if __name__ == "__main__":
    ...
    # def writereturn(self):
    #     strlist = ["@LCL", "D = M", "@R13", "M = D", "@5", "D = A", "@R13", "D = M-D", "A = D", "D= M", "@R14",
    #                "M=D"]
    #     strlist.extend(self.pop2("ARG", "0"))
    #     strlist.extend(["@ARG", "D = M", "@SP", "M = D+1"])
    #     strlist.extend(self.restore_from_stack("THAT"))
    #     strlist.extend(self.restore_from_stack("THIS"))
    #     strlist.extend(self.restore_from_stack("ARG"))
    #     strlist.extend(self.restore_from_stack("LCL"))
    #     strlist.extend(["@R14", "A = M", "0;JMP"])
    #     return strlist



    # def restore_from_stack(self, location):
    #     return ["@R13", "M = M-1", "A = M", "D = M", "@" + location, "M =D"]
    ...
    #     self.funccounter += 1
    #     strlist = []
    #     strlist.extend(self.save_to_stack("RETURN"))
    #     strlist.extend(self.save_to_stack("LCL"))
    #     strlist.extend(self.save_to_stack("ARG"))
    #     strlist.extend(self.save_to_stack("THIS"))
    #     strlist.extend(self.save_to_stack("THAT"))
    #     strlist.extend(["@SP", "D = M", "@" + str(int(num) + 5), "D = D-A", "@ARG", "M=D", "@SP", "D=M", "@LCL", "M=D"])
    #     strlist.extend(self.writegoto(string))
    #     strlist.extend(self.writelabel("RETURN" + str(self.funccounter)))
    #     return strlist
